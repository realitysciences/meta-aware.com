    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-24 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="text-sm bg-[#0a6b5e] text-white px-4 py-2 rounded-lg hover:bg-[#0d7f6f] transition-colors">Get Started</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-24 pb-20 px-6 bg-gradient-to-br from-[#e8f7f3] via-white to-white">
        <div className="max-w-4xl mx-auto text-center pt-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
            The platform for<br />
            <span className="text-[#0a6b5e]">psychological terrain</span><br />
            mapping.
          </h1>
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Record sessions, auto-transcribe with speaker labels, and run multi-lens psychological analyses. Built for therapists, coaches, and somatic practitioners.
          </p>
      ...
      <section id="how-it-works" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Record Your Session', desc: 'Capture audio directly in the browser with consent confirmation. Pause and resume as needed.' },
              { step: '02', title: 'AI Transcription', desc: 'AssemblyAI automatically transcribes with speaker diarization, labeling Practitioner and Client turns.' },
              { step: '03', title: 'Terrain Analysis', desc: 'Run the transcript through 8 psychological lenses — ReLoHu, IFS, Jungian, Attachment, and more.' },
            ].map(item => (
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500">Built for practitioners who go deep</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: '🧠', title: 'Therapists', desc: 'Complement your clinical practice with structured terrain mapping across multiple psychological frameworks.' },
              { icon: '🎯', title: 'Coaches', desc: "Move beyond surface-level conversation. Understand the underlying patterns driving your clients' behavior." },
              { icon: '🌿', title: 'Somatic Practitioners', desc: 'Integrate body-based observations with psychological frameworks for a complete picture of the terrain.' },
            ].map(item => (
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { title: 'Session Recording', desc: 'Browser-based audio recording with consent flow, pause/resume, and live waveform visualization.' },
              { title: 'AI Transcription', desc: 'Automatic transcription with speaker diarization via AssemblyAI. Know exactly who said what.' },
              { title: 'Terrain Mapping', desc: '8 psychological lenses including ReLoHu, Jungian, IFS, Attachment, Enneagram, and more.' },
              { title: 'Client Reports', desc: 'Generate PDF reports from analyses to review patterns over time or share with supervision.' },
            ].map(item => (
      ...
      <footer className="py-12 px-6 border-t border-gray-100">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-400">© 2025 meta-aware. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
